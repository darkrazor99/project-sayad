    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="{{ url('/service') }}" class="btn btn-success py-2 px-4 ms-3"> To English</a>
            </div>
        </nav>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">{{ $service->small_ar }}</h5>
                <h1 class="mb-0">{{ $service->mainh_ar }}</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s1_ar }}</h4>
                        <p class="m-0">{{ $service->p1_ar }}</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s2_ar }}</h4>
                        <p class="m-0">{{ $service->p2_ar }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s3_ar }}</h4>
                        <p class="m-0">{{ $service->p3_ar }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s4_ar }}</h4>
                        <p class="m-0">{{ $service->p4_ar }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s5_ar }}</h4>
                        <p class="m-0">{{ $service->p5_ar }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <h3 class="text-white mb-3">{{ $service->mainphone_ar }}</h3>
                        <p class="text-white mb-3">{{ $service->p6_ar }}</p>
                        <h2 class="text-white mb-0">{{ $getInTouch->phone }}</h2>
                    </div>
                </div>
            </div>
        </div>
