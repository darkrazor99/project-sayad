            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    {{-- <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle"
                        href="{{ $getInTouch->address }}"><i class="fab fa-youtube fw-normal"></i></a> --}}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="{{ url('/about') }}" class="btn btn-success py-2 px-4 ms-3"> To English</a>
            </div>
        </nav>
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">{{ $aboutUs[0]->getAttribute('h1-ar') }}</h1>
                    </div>
                    <p class="mb-4">{{ $aboutUs[0]->getAttribute('p-ar') }}</p>
                    <div class="row g-0 mb-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i
                                    class="fa fa-check text-primary me-3"></i>{{ $aboutUs[0]->getAttribute('sh1-ar') }}
                            </h5>
                            <h5 class="mb-3"><i
                                    class="fa fa-check text-primary me-3"></i>{{ $aboutUs[0]->getAttribute('sh2-ar') }}
                            </h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i
                                    class="fa fa-check text-primary me-3"></i>{{ $aboutUs[0]->getAttribute('sh3-ar') }}
                            </h5>
                            <h5 class="mb-3"><i
                                    class="fa fa-check text-primary me-3"></i>{{ $aboutUs[0]->getAttribute('sh4-ar') }}
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                        <div class="team-item bg-light rounded overflow-hidden">
                            ...
                            <div class="text-center py-4">
                                <h4 class="text-primary">{{ $member->getAttribute('name-ar') }}</h4>
                                <p class="text-uppercase m-0">{{ $member->getAttribute('job-ar') }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
