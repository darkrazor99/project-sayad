                ...
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="{{ url('/blog-ar') }}" class="dropdown-item active">Blog Grid</a>
                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="{{ '0' . $i }}s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <a class="text-uppercase" href="{{ url('/blog-ar/' . $articals[$i]->id) }}">Read
