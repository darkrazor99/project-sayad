    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="{{ url('/service-ar') }}" class="btn btn-success py-2 px-4 ms-3">اللغة العربية</a>
            </div>
        </nav>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">{{ $service->small }}</h5>
                <h1 class="mb-0">{{ $service->mainh1 }}</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s1 }}</h4>
                        <p class="m-0">{{ $service->p1 }}</p>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s2 }}</h4>
                        <p class="m-0">{{ $service->p2 }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s3 }}</h4>
                        <p class="m-0">{{ $service->p3 }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s4 }}</h4>
                        <p class="m-0">{{ $service->p4 }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s">
                    <div
                        ...
                        <h4 class="mb-3">{{ $service->s5 }}</h4>
                        <p class="m-0">{{ $service->p5 }}</p>
                        {{-- <a class="btn btn-lg btn-primary rounded" href="">
                            <i class="bi bi-arrow-right"></i>
                        </a> --}}
                    </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        ...
                        <h3 class="text-white mb-3">{{ $service->mainphone }}</h3>
                        <p class="text-white mb-3">{{ $service->p6 }}</p>
